...
from DbServer.DbDataServer import DbDataServer as Dds
...
class DbMainServer:
    def __init__(self):
        ...
        # 初始化数据库连接
        self.conn, self.cursor = Dds.openDb(Cs.returnRoomDbPath())
    ...
    def __del__(self):
        ...
        if hasattr(self, 'conn') and hasattr(self, 'cursor'):
            Dds.closeDb(self.conn, self.cursor)
    ...
    def addMonitorRoom(self, roomId, roomName):
        ...
        :return: bool
        """
        return self.Drs.addMonitorRoom(roomId, roomName)
    ...
    def delMonitorRoom(self, roomId):
        ...
        :return: bool
        """
        return self.Drs.delMonitorRoom(roomId)
    ...
    def searchMonitorRoom(self, roomId):
        ...
        """
        return self.Drs.searchMonitorRoom(roomId)
    ...
    def showMonitorRoom(self):
        ...
        :return: dict
        """
        return self.Drs.showMonitorRoom()
    ...
    def saveRoomMembers(self, roomId, members):
        ...
        :return: bool
        """
        return self.Drs.saveRoomMembers(roomId, members)
    ...
    def getRoomMembers(self, roomId):
        ...
        :return: list or None
        """
        return self.Drs.getRoomMembers(roomId)

    def addLeftMemberRecord(self, room_id, member_id, member_name):
        """
        添加退群记录
        :param room_id: 群ID
        ...
        """
        return self.Drs.addLeftMemberRecord(room_id, member_id, member_name)

    def getLeftMemberRecords(self, room_id):
        """
        获取群的退群记录
        :param room_id: 群ID
        :return: 退群记录列表
        """
        return self.Drs.getLeftMemberRecords(room_id)

    def clearLeftMemberRecords(self, room_id=None):
        """
        清除退群记录
        :param room_id: 群ID，如果不指定则清除所有记录
        :return: bool
        """
        return self.Drs.clearLeftMemberRecords(room_id)
